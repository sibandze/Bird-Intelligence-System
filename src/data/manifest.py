...
def load_manifest(manifest_path: Optional[Path] = None, config: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
...
def save_manifest(manifest: Dict[str, Any], manifest_path: Optional[Path] = None, config: Optional[Dict[str, Any]] = None):
    path = Path(manifest_path) if manifest_path else _default_manifest_path(config)
...
def is_processed(rc_id: str, manifest: Dict[str, Any], npy_path: Optional[Path] = None) -> bool:
...
def is_downloaded(rc_id: str, manifest: Dict[str, Any], audio_path: Optional[Path] = None) -> bool:
    entry = manifest.get(rc_id)
